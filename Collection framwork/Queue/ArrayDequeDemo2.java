...
class ArrayDequeDemo2{
	public static void main(String [] args){
		ArrayDeque<Integer> queue = new ArrayDeque<Integer>(); // Valid - we can use Deque methods +  Queue methods
...
D:\Final Interview\Collection framwork\Queue>java ArrayDequeDemo2.java
