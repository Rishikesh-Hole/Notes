...
class LinkedListDemo{
	public static void main(String [] args){
		//LinkedList<String> AS = new LinkedList<String>(); // Valid
		List<String> AS = new LinkedList<String>(); // Valid
		AS.add("Rishikesh");
		AS.add("Saylee");
		AS.add("Charvi");
		AS.add("Ronu");
...
D:\Final Interview\Collection framwork\List>java LinkedListDemo.java
