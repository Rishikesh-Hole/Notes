...
class MyClass implements Comparable<MyClass>{
	...
	public static void main(String [] args){
		...
		TreeSet<MyClass> TS2 = new TreeSet<MyClass>(new MyClassComparator());
		TS2.add(new MyClass(301, "Rishikesh"));
		TS2.add(new MyClass(203, "Ankit"));
		TS2.add(new MyClass(152, "Karan"));
		TS2.add(new MyClass(770, "Sankalp"));
		TS2.add(new MyClass(430, "Sankalp"));
...
/*
D:\Final Interview\Collection framwork\coding>java MyClassCombine.java
[ Studen ID: 101 Name: Rishikesh]
[ Studen ID: 102 Name: Karan]
[ Studen ID: 103 Name: Ankit]
[ Studen ID: 110 Name: Sankalp]

[ Studen ID: 152 Name: Karan]
[ Studen ID: 203 Name: Ankit]
[ Studen ID: 301 Name: Rishikesh]
[ Studen ID: 430 Name: Sankalp]
[ Studen ID: 770 Name: Sankalp]
